      ...
      body: PageView.builder(
        ...
        itemBuilder: (ctx, ind) {
          ...
          children: [
            ...
            SizedBox(
              width: mq.width*.7,
              child: Text('I can be your best friend & You can ask me any thing & I will help you',
                textAlign: TextAlign.center, style: TextStyle(fontSize: 13.5,letterSpacing: .5),),
            ),
            const Spacer(),
            Wrap(
              spacing: 10,
            ...
            ElevatedButton(
                style: ElevatedButton.styleFrom(shape: const StadiumBorder(),elevation: 0,
                    ...
                    backgroundColor: Colors.blue,minimumSize: Size(mq.width * .4,50)),
                onPressed: (){
                  if (isLast) {
